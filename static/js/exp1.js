...
var debrief = [{
    ...
    <p>ביום א׳ הקרוב תקבלו מייל עם קישור המזמין אתכם להשתתף בחלק השני של המחקר. תוכלו לעשות זאת באותו היום, או למחרת. השתתפות בחלק הבא של המחקר תזכה אתכם בתשלום נוסף.</p></div>'],
